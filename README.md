...
Prospects were predicted using Random Forest Regressors trained on data scraped from [BasketballReference](https://www.basketballreference.com/) and [SportsReference](https://www.sports-reference.com/).
